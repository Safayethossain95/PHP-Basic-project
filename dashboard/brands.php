    <?php 
          ...
          $deactivate_service = "SELECT * FROM brands WHERE status= 2";
   ...
   <div class="row mt-5">
    <div class="col-12 ">
       ...
       <div class="card bg-white table-bordered ">
         ...
         <a href="add-brands.php" class="text-right pr-4 pt-3"><i class="fa fa-plus"></i> Add</a>
         <div class="card-body">
           <div class="container">
                ...
                <tbody>
                  <?php 
                    ...
                    <td class="text-center">
                        <?php 
                        if($portfolio['logo']== NULL){
                          echo "N/A";
                        }
                        else{
                          ?>
                           <img width="100" src="../assets/images/brands/<?php echo $portfolio['logo'];?>">
